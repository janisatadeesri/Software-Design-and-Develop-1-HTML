         ...
         <fieldset>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input type="checkbox" id="sport" name="interests" value="sport">
                    <label for="sport">ว่ายน้ำ</label>
                    <input type="checkbox" id="music" name="interests" value="music">
                    <label for="music">วิ่ง</label>
                    <input type="checkbox" id="art" name="interests" value="art">
                    <label for="art">แบตมินตัน</label>
                    <input type="checkbox" id="tech" name="interests" value="tech">
                    <label for="tech">ฟุตซอล</label>
                    <input type="checkbox" id="tech" name="interests" value="tech">
                    <label for="tech">วอล์เลย์บอล</label>
                    <input type="checkbox" id="tech" name="interests" value="tech">
                    <label for="tech">ปิงปอง</label>
                    <input type="checkbox" id="tech" name="interests" value="tech">
                    <label for="tech">มวย</label>
                </div>
            </fieldset>
...
Screenshot 2568-02-06 at 00.35.47
